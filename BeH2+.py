...
electron3 = ChargedParticle(charge = -1, mass = 1,
                            initialPosition = (bondLength,  bondLength), 
                            initialMomentum = (1.1, 0.0), 
                            radiates = True)

                            
electron4 = ChargedParticle(charge = -1, mass = 1,
                            initialPosition = (-bondLength,  -bondLength), 
                            initialMomentum = (-1.1, 0.0), 
                            radiates = True)

hydrogen2Plus = chargedParticleUniverse([berllyium, proton1, proton2, electron1, electron2, electron3, electron4], timeStep = .05)

hydrogen2Plus.evolveNTimeSteps(700)
